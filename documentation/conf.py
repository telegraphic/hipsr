# -*- coding: utf-8 -*-
#
# HIPSR documentation build configuration file, created by
...
latex_documents = [
  ('index', 'HIPSR.tex', u'HIPSR Documentation',
...
man_pages = [
    ('index', 'hipsr', u'HIPSR Documentation',
     [u'Danny Price'], 1)
]
